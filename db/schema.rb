...
ActiveRecord::Schema.define(:version => 20100413231329) do

  create_table "grocery_ingredients", :force => true do |t|
    t.integer  "user_id"
  ...
  create_table "recipes", :force => true do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "serving_qty",        :default => 1
  ...
  create_table "unit_conversion", :force => true do |t|
  end
